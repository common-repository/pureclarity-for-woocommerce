 ...
 * Class CategoryTest
 *
 * Unit Test for \PureClarity\Api\Delta\Type\Category
 *
 * @see \PureClarity\Api\Delta\Type\Category
 */
class CategoryTest extends MockeryTestCase
{
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(Category::class, $subject);
    ...
    {
        $this->mockTransfer('create', '{"Version": 2, "Categories":[');
    ...
    public function testAppendInvalid()
    {
        ...
        $this->assertEquals(
            'Missing Id|Missing DisplayName|Missing Image|Missing Link|Missing ParentIds|Missing Description',
            $error
        );
    }
