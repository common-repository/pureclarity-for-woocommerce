...
namespace PureClarity\Tests\Unit\Api\Delete;

use Exception;
use Mockery\MockInterface;
use PureClarity\Api\Delete\Submit;
use Mockery as m;
 ...
 * Class SubmitTest
 *
 * Unit Test for PureClarity\Api\Delete\Submit
 *
 * @see \PureClarity\Api\Delete\Submit
 */
class SubmitTest extends MockeryTestCase
{
    ...
    /**
     * Sets up the test subject - \PureClarity\Api\Delete\Submit class
     */
    ...
    private function mockEndpoint()
    {
        ...
        $endpoints->shouldReceive('getDeleteEndpoint')
            ->times(1)
            ->with('1')
