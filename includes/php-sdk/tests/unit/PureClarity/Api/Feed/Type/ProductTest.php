...
class ProductTest extends MockeryTestCase
{
    ...
    {
        $this->mockTransfer('create', '{"Version": 2, "Products":[');
    ...
    public function testAppendInvalid()
    {
        ...
        $this->assertEquals(
            'Missing Id|Missing Title|Missing Categories|Missing Link|Missing Image|Missing Prices',
            $error
        );
    }

    /**
     * Tests attempting to append empty data returns the correct type-specific errors
     */
    public function testAppendEmpty()
    {
        ...
        $this->assertEquals(
            'Missing data for Id|Missing data for Title|Missing data for Link|Missing data for Prices',
            $error
        );
    }
